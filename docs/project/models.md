...
|------|--------|-----------|------------|--------------|
| OCR / Vision | `gemini-3.1-flash-preview` | $0.15/M | $0.60/M | OCR manuscrits, faible coût volume (~4 000 pages/$1) |
| Raisonnement complexe | `gemini-3.1-pro-preview` | $1.25/M | $5.00/M | Thinking L2, contexte 1M tokens, désambiguïsation noms |
| Routing / tâches simples | `gemini-3.1-flash-lite-preview` | $0.05/M | $0.20/M | Latence <100ms |
...
| Tâche | Modèle |
|-------|--------|
| OCR actes manuscrits | `gemini-3.1-flash-preview` |
| Désambiguïsation, raisonnement cross-sources | `gemini-3.1-pro-preview` |
| Embeddings fiches + images actes | `gemini-embedding-2-preview` |
| Agent post-1900 (génération courrier) | `gemini-3.1-flash-preview` |
